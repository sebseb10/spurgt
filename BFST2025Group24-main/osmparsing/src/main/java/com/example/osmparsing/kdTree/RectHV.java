...
public final class RectHV {
     ...
     */
    public boolean contains(com.example.osmparsing.kdTree.KdPoint2D p) {
     ...
     */
    public double distanceTo(com.example.osmparsing.kdTree.KdPoint2D p) {
     ...
     *         in this rectangle
     */
    public double distanceSquaredTo(com.example.osmparsing.kdTree.KdPoint2D p) {
